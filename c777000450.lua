...
function s.accostfilter(c)
  return c:IsSetCard(0x297) and c:IsType(TYPE_MONSTER) and (c:IsLocation(LOCATION_HAND) or c:IsFaceup()) and c:IsAbleToGraveAsCost()
end
...
function s.spfilter(c,e,tp)
  return c:IsSetCard(0x297) and c:IsType(TYPE_SYNCHRO)
