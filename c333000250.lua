...
function s.spcon1(e,tp,eg,ep,ev,re,r,rp)
	...
	return e:GetHandler():IsPreviousLocation(LOCATION_DECK) and rc:IsCode(333000240)
end
	--Activation legality
...
local nb=Duel.GetFieldGroupCount(tp,LOCATION_HAND,0)-Duel.GetFieldGroupCount(tp,0,LOCATION_HAND)
local g=Duel.SelectTarget(tp,s.cfilter,tp,LOCATION_ONFIELD,LOCATION_ONFIELD,1,nb,nil)
	Duel.SendtoHand(g,nil,REASON_EFFECT)
end
-- add 1 ritual spell or monster
