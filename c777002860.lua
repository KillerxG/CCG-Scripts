...
--(3)Special Summon Level 4 or lower
function s.spfilter(c,e,tp)
	return c:IsLevelBelow(4) and c:IsSetCard(0x133) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
