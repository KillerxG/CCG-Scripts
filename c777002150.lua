...
function s.filter(c,tp)
	return c:IsFaceup() and c:IsSetCard(0x309) and c:IsType(TYPE_MONSTER) and c:IsType(TYPE_EXTRA+TYPE_RITUAL)
...
function s.ffilter(c)
	return c:IsFaceup() and c:IsSetCard(0x9999) and c:IsType(TYPE_RITUAL)
end
