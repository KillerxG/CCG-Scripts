...
function s.tgfilter(c)
	return c:IsType(TYPE_MONSTER) and c:IsSetCard(0x296) and c:IsAbleToGraveAsCost()
...
function s.tdfilter(c)
	return c:IsType(TYPE_MONSTER) and c:IsSetCard(0x296) and c:IsAbleToDeck()
end
...
function s.spfilter(c,e,tp)
	return (c:IsSetCard(0x296) and not c:IsType(TYPE_LINK)) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
