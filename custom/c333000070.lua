...
function s.atkval(e,c)
    return Duel.GetCounter(0,1,0,0x311)*100
end
--gain counter
...
function s.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,aux.NecroValleyFilter(s.sfilter),tp,LOCATION_HAND+LOCATION_GRAVE+LOCATION_DECK,0,1,1,nil,lv,e,tp)
...
function s.splimit(e,c)
	return not c:IsSetCard(0x311) and c:IsLocation(LOCATION_EXTRA)
end
function s.lizfilter(e,c)
	return not c:IsOriginalSetCard(0x311)
end