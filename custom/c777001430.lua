...
function s.thfilter(c,e,tp,chk)
	return c:IsSetCard(0x307) and c:IsLevelBelow(4) and not c:IsCode(id) and (c:IsAbleToHand() or (chk==1 and Duel.GetLocationCount(tp,LOCATION_MZONE)>0 and c:IsCanBeSpecialSummoned(e,0,tp,false,false)))
end
