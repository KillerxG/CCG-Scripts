...
function s.filter2(c,lv,code)
	return c:IsSetCard(0x304) and c:IsType(TYPE_MONSTER) and c:IsAbleToHand() and c:GetOriginalLevel()==lv and not c:IsCode(code)
end
...
function s.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if b and Duel.CheckReleaseGroupCost(tp,s.thcfilter,1,true,nil,nil,tp)
