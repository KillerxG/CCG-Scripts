...
function s.filter2(c,e,tp,m,f)
	return c:IsType(TYPE_FUSION) and c:IsSetCard(0x305) and (not f or f(c))
...
function s.filterchk(c)
	return c:IsType(TYPE_FUSION) and c:IsSetCard(0x305) and not c:IsHasEffect(id)
end
